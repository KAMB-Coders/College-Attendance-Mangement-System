		...
		<div class="main_menu">
			...
			<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
				<ul class="nav navbar-nav menu_nav ml-auto">
					<li class="nav-item"><a class="nav-link" href="facultyHome.jsp" style="font-style: italic;">Home</a></li>
	...
	<div class="inner_content_w3_agile_info">
		<div class="agile_top_w3_grids">
			<ul class="ca-menu" style="display: flex; justify-content: center;">
				<li>
					<a href="scheduleLecture1.jsp">
						<i class="fa fa-user" aria-hidden="true"></i>
						<div class="ca-content">
							<h4 class="ca-main one" style="font-size: 12px "> Here you can Schedule your lectures </h4>
							<h3 class="ca-sub one">Schedule Lecture</h3>
						</div>
					</a>
				</li>
				<li>
					<a href="facultyViewSchedule.html">
						<i class="fa fa-building-o" aria-hidden="true"></i>
						<div class="ca-content">
							 <h4 class="ca-main two" style="font-size: 12px"> Here you can check scheduled lectures and Mark Attendance </h4>
							<h3 class="ca-sub two">Mark Attendance</h3>
						</div>
					</a>
				</li>
				<li>
					<a href="AviewClassAttendance.html">
						...
						<div class="ca-content">
							<h4 class="ca-main three"style="font-size: 12px"> Here you can Check student attendance </h4>
							<h3 class="ca-sub three">View Attendance</h3>
						</div>
					</a>
				</li>
				<div class="clearfix"></div>
