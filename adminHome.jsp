		...
		<div class="main_menu">
			...
			<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
				<ul class="nav navbar-nav menu_nav ml-auto">
					<li class="nav-item"><a class="nav-link" href="adminHome.jsp" style="font-style: italic;">Home</a></li>
	...
	<div class="inner_content_w3_agile_info">
		<div class="agile_top_w3_grids">
			<ul class="ca-menu" style="display: flex; justify-content: center;">
				<li>
					<a href="AviewClassAttendance.html">
						<i class="fa fa-user" aria-hidden="true"></i>
						<div class="ca-content">
							<h4 class="ca-main one"style="font-size: 12px"> Here you can Check student attendance </h4>
							<h3 class="ca-sub one">View Attendance</h3>
						</div>
					</a>
				</li>
				<li>
					<a href="AviewFaculty.html">
						<i class="fa fa-building-o" aria-hidden="true"></i>
						<div class="ca-content">
							 <h4 class="ca-main two" style="font-size: 12px"> Here you can check Faculity Details </h4>
							<h3 class="ca-sub two"> View Faculty List</h3>
						</div>
					</a>
				</li>
				<li>
					<a href="AviewStudentList.html">
						<i class="fa fa-database" aria-hidden="true"></i>
						<div class="ca-content">
							<h4 class="ca-main three"style="font-size: 12px"> Here you can view student (branch & semester)</h4>
							<h3 class="ca-sub three">View Student List</h3>
						</div>
					</a>
				</li>
				<li>
					<a href="addFaculty.html">
						...
						<div class="ca-content">
							<h4 class="ca-main four" style="font-size: 12px "> Here you can Add Recently joined faculty </h4>
							<h3 class="ca-sub four">Add new Faculty</h3>
						</div>
					</a>
				</li>
				<div class="clearfix"></div>
